...
export class ExchangeRatesApiStub extends ExchangeRatesApi {
  async getExchangeRates(): Promise<Map<string, ExchangeRate>> {
    return new Map([
      ["EUR/USD", { value: 1.23, date: new Date("2024-07-16 07:14:45") }],
      ["USD/EUR", { value: 0.81, date: new Date("2024-07-16 07:14:45") }],
      ["GBP/USD", { value: 0.75, date: new Date("2024-07-16 07:14:45") }],
      ["USD/GBP", { value: 1.33, date: new Date("2024-07-16 07:14:45") }],
    ]);
  }
}
